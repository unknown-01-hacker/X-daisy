...
PM_START_TEXT = """
Hello there, I'm [𖣘 𝗣𝗿𝘂𝘁𝗵𝘃𝗶 𝗥𝗮𝗷 𖣘](https://telegra.ph/file/465456555d84c4c73b2c3.jpg)
...
HELP_STRINGS = f"""
*Main Commands :* [𖣘 𝗣𝗿𝘂𝘁𝗵𝘃𝗶 𝗥𝗮𝗷 𖣘](https://telegra.ph/file/465456555d84c4c73b2c3.jpg)
...
STR_E = "CAACAgIAAxkBAAIBL2BoT0dj1kkS7ZglPKRZpp563qbcAAKoAANLQiIRdYa2Tk4w31seBA"

DONATE_STRING = """Heya, glad to hear you want to donate!
You can donate to the original writer's of the Base code,
Support them  [-----](t.me/The_NOoBHaCkeR)"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(STR_E),
            update.effective_message.reply_text(
                PM_START_TEXT,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(text="𝗠𝗲", callback_data="aboutmanu_tac"),
                    ],
                    [InlineKeyboardButton(text="𝗛𝗲𝗹𝗽", callback_data="help_back")],
